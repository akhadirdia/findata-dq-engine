...
class AccessLog(BaseModel):
    ...
    payload_size: Optional[int] = Field(default=None, ge=0, description="Taille en bytes")
...
class Transaction(BaseModel):
    ...
    num_police: Optional[str] = Field(default=None, description="Police associée si applicable")
    id_sinistre: Optional[str] = Field(default=None, description="Sinistre associé si applicable")
    ...
    flag_fraude: Optional[bool] = Field(default=None, description="Label fraude confirmée (pour entraînement)")
...
class ThreatLog(BaseModel):
    ...
    threat_category: Optional[Literal[
        ...
        "data_exfiltration", "privilege_escalation", "unknown"
    ]] = None
    blocked: bool = False
    date_creation: Optional[datetime] = None
